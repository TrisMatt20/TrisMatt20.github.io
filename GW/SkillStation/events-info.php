    ...
    <?php if (mysqli_num_rows($eventResult) > 0) {
        ...
        while ($eventRow = mysqli_fetch_assoc($eventResult)) {
            ...
            <div class="banner position-relative" style="height: 300px">
                ...
                <div class="position-absolute w-100 h-100 banner-overlay"></div>
                <div class="container pt-5">
                    <div class="text-overlay text-white position-absolute">
                        ...
                        <p class="mt-2"><i class="bi bi-geo-alt-fill me-2"></i><?php echo $eventRow['address'] ?></p>
                        <a class="btn btn-primary px-5" href="attend.php?eventId=<?php echo $eventRow['eventId'] ?>">Attend</a>
                    </div>
                </div>
            </div>

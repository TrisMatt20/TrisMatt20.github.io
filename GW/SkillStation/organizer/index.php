...
<body>
    ...
    <div class="container my-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-end d-flex flex-wrap justify-content-md-end gap-2">
                ...
                <div class="dropdown">
                    <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="organizerDropdownButton"
                        data-bs-toggle="dropdown">All Events</button>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" onclick="updateOrganizerFilter(true)">My Events</a></li>
                        <li><a class="dropdown-item" onclick="updateOrganizerFilter(false)">All Events</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <script>
        var organizerId = <?php echo $organizerId ?>;
